...
#define G_TRI4 0xB1   // GoldenEye: até 4 triangulos empacotados (G_IMMFIRST - 14)
#define G_SETTEX 0xC0 // GoldenEye: setup de textura combinado (próximo passo)
...
static void gfx_run_dl(Gfx *cmd)
{
    ...
    for (;;)
    {
        ...
        case (uint8_t)G_TRI4:
        {
            uint8_t z1 = C0(0, 4), z2 = C0(4, 4), z3 = C0(8, 4), z4 = C0(12, 4);
            uint8_t x1 = C1(0, 4), y1 = C1(4, 4);
            uint8_t x2 = C1(8, 4), y2 = C1(12, 4);
            uint8_t x3 = C1(16, 4), y3 = C1(20, 4);
            uint8_t x4 = C1(24, 4), y4 = C1(28, 4);

            if (x1 | y1 | z1)
                gfx_sp_tri1(x1, y1, z1);
            if (x2 | y2 | z2)
                gfx_sp_tri1(x2, y2, z2);
            if (x3 | y3 | z3)
                gfx_sp_tri1(x3, y3, z3);
            if (x4 | y4 | z4)
                gfx_sp_tri1(x4, y4, z4);
            break;
        }
